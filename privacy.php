...
<section class="card public-page legal-page">
  ...
  <section class="legal-section"><h3>2. 利用目的</h3><p>アカウント管理、日誌・経費・売上・年間集計・CSV出力などの機能提供、不具合対応、削除依頼対応、サービス改善、サービス運営上の連絡、およびユーザーが同意した場合の機能追加・活用情報などのお知らせ配信のために利用します。</p></section>
