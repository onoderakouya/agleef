...
$pageTitle = 'AGLEEF-アグリーフ- | 農業の記録を、もっとかんたんに。';
?>
<!DOCTYPE html>
<html lang="ja">
<head>
  ...
  <meta name="description" content="AGLEEF-アグリーフ-は、日々の作業日誌・売上・経費をまとめて記録できる、農家のためのシンプルな農業日誌アプリです。">
...
<body>
  <header class="lp-header">
    <div class="lp-container lp-header__inner">
      <a class="lp-brand" href="index.php" aria-label="AGLEEF-アグリーフ- トップページ">
        <span class="lp-brand__title">AGLEEF-アグリーフ-</span>
    ...
    <section class="hero">
      <div class="lp-container hero__grid">
        <div class="hero__content">
          ...
          <p class="hero__lead">AGLEEF-アグリーフ-は、日々の作業日誌・売上・経費をまとめて記録できる、農家のためのシンプルな農業日誌アプリです。</p>
        ...
        <div class="hero__panel" aria-label="アグリーフで記録できる内容">
    ...
    <section class="section notice-section" aria-labelledby="notice-title">
      <div class="lp-container">
        <div class="notice-box">
          ...
          <p>アグリーフの集計機能は、入力されたデータをもとにした簡易集計です。確定申告や税務上の最終判断については、税理士・税務署等へ確認してください。</p>
        </div>
      </div>
    </section>
  ...
  <footer class="lp-footer">
    <div class="lp-container">
      <p>© 2026 AGLEEF-アグリーフ-</p>
      <p><a href="contact.php">お問い合わせ・改善要望</a></p>
      <p>農業日誌アプリ</p>
    </div>
  </footer>
</body>
